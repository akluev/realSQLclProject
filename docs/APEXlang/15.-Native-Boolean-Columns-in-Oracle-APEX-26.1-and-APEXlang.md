...
![APEX Page Designer showing Boolean Source and Session State data types](<images/boolean session state.png>)

*Figure 15-1. The Source data type is already `BOOLEAN`; the crossed-out `VARCHAR2` Session State value must be changed to `BOOLEAN`.*
