...
> **<span colorid="n659vnwbp3">Note:</span>** it’s important to DELETE APEX application files in ‘src’ before exporting, otherwise you may not see deleted pages and shated components until it’s too late…
...
## 2.3.<span colorid="ccg2qva3e5"> Tricky: </span>Export Changes In Grants To Application Schema

> **<span colorid="i4snq0zf9v">Note:</span>** This is a bit tricky ( actually it’s really tricky) due to several implementation bugs in SQLcl Project. Fortunately, this task is not a part of ordinary change.
...
- **<span colorid="owmx3fnjxb">Attention! When you open the files in VS Code, you will notice that new grants for the current user are added and grants for other users are REMOVED. This is a very severe bug with SQLcl Project at the time of writing.</span>**
...
> Note: You may note changes to “ORDS” that you did not make. **<span colorid="yn7ainrrmu">This is another bug with SQLcl . </span>** You should get rid of these changes either by pressing “Disacard” button in VS Code or running Git Command
>
...
## 2.7. <span colorid="oh312fq7dr">Tricky</span>:Add ORDS Changes
...
**-- changeset CLA_APEX:1761764378736.<span colorid="kjns0hko7l">\[1-4\]</span> stripComments:false logicalFilePath:dev-02\cla_apex\tables\cla_aircraft.sql**

That allows the installation process to become restartable regradless at what statement the process fails

##  2.8. <span colorid="oyplqpr41u">Tricky:</span> Re-Staging
...
- In VS Code in Changes **<span colorid="j3003w0hu2">very careful review all changed files and make case-by-case decision if you wan to:</span>**
...
# 5. <span colorid="pik1eb8l17">Optional: </span>Build Deployment Articact
