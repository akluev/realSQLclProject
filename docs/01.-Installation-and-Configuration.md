...
- [2. Configuration](#2-configuration)
  - [2.1. VM Database](#21-vm-database)
    ...
    - [2.1.2. Make Sure Bidirectional Clipboard Sharing is Running](#212-make-sure-bidirectional-clipboard-sharing-is-running)
      - [2.1.2.1. Troubleshooting: VirtualBox Clipboard Stops Working (Linux Guest)](#2121-troubleshooting-virtualbox-clipboard-stops-working-linux-guest)
        - [Symptoms](#symptoms)
        - [Cause](#cause)
        - [Quick Fix (No Reboot Required)](#quick-fix-no-reboot-required)
        - [Optional Convenience Alias](#optional-convenience-alias)
